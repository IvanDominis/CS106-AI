...
class Game:
    ...
    def load_textures(self):
       ...
       self.textures = {
           SOKOBAN.WALL: pygame.image.load(ivan+'assets/images/wall.png').convert_alpha(),
           SOKOBAN.BOX: pygame.image.load(ivan+'assets/images/box.png').convert_alpha(),
           SOKOBAN.TARGET: pygame.image.load(ivan+'assets/images/target.png').convert_alpha(),
           SOKOBAN.TARGET_FILLED: pygame.image.load(ivan+'assets/images/valid_box.png').convert_alpha(),
           SOKOBAN.PLAYER: pygame.image.load(ivan+'assets/images/player_sprites.png').convert_alpha()
       }
